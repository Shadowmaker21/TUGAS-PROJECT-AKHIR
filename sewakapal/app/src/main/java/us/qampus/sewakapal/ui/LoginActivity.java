...
import buildup.services.DefaultLoginService;
import buildup.ui.BaseLoginActivity;
import buildup.util.ConnectivityUtils;
        ...
        return new DefaultLoginService(getString(R.string.login_url)){
            ...
            protected void onPostExecute(Map<String, String> loginParams) {
                ...
                if (expirationTimeString != null) {
                    ...
                    Intent goToMainActivity = new Intent(getApplicationContext(), SewaKapalMainActivity.class);
